...
//Rutas usuarios
router.post('/users', usersController.createUsuarios)
router.post('/users/login', usersController.authenticate)
router.get('/users/login', usersValidation.isAuthorized, usersValidation.isAdmin, usersController.getUsuarios)
